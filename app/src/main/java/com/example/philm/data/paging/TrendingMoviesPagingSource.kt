...
class TrendingMoviesPagingSource(private val apiService: NetworkService) : PagingSource<Int, TrendingResult>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, TrendingResult>{
        ...
        return try {
            val data = apiService.getTrendingMovie(TimeWindow.day.toString())
